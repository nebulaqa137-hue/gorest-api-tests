...
/**
 * NegativeUserTests — valida que la API responda correctamente a entradas inválidas.
 *
 * GoRest usa 422 (Unprocessable Entity) para errores de validación de negocio.
 */
@Epic("Usuarios")
...
public class NegativeUserTests extends BaseTest {
    ...
    public void createUser_withInvalidGender_shouldReturn422() {
        ...
        .then()
                ...
                .body("[0].message", containsStringIgnoringCase("invalid"));
    }
    ...
    public void createUser_withDuplicateEmail_shouldReturn422() {
        ...
        try {
            ...
            User duplicate = User.builder()
                    .name("Another User")
                    .email(original.getEmail())  // mismo email → duplicado
                    .gender("male")
                    .status("active")
                    .build();
